...
const getEventIcon = (eventType: string) => {
  ...
  switch (eventType) {
    ...
    case "order.canceled":
      return <XCircleSolid className={clx(iconClass, "text-red-500")} />
    case "order.completed":
      return <CheckCircleSolid className={clx(iconClass, "text-green-600")} />
    ...
    case "fulfillment.shipment_created":
      return <DocumentText className={clx(iconClass, "text-purple-500")} />
    case "notification.sent":
      return <EnvelopeSolid className={clx(iconClass, "text-blue-400")} />
    case "return.created":
    case "claim.created":
      return <ArrowPath className={clx(iconClass, "text-yellow-500")} />
    default:
      return <CheckCircleSolid className={clx(iconClass, "text-gray-400")} />
  }
}
